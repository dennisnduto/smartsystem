    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Published Timetables') }}
            </h2>
            <a href="{{ route('super-admin.dashboard') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                Back to Dashboard
            </a>
        </div>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    <div class="mb-4">
                        <p class="text-sm text-gray-600">
                            Showing only published timetables. Timetables only appear here after being published by institution administrators.
                        </p>
                    </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($timetables as $timetable)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            {{ $timetable->published_at ? $timetable->published_at->format('M d, Y g:i A') : 'N/A' }}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900">{{ $timetables->total() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900">{{ $timetables->unique('institution_id')->count() }}</p>
                        </div>
                    </div>
                </div>
