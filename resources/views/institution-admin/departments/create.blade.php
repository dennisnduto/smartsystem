...
<header class="bg-gradient-to-r from-blue-600 to-indigo-700 shadow-lg">
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-3xl font-bold text-white">Create Department</h1>
                <p class="text-blue-100 mt-1">Add a new department to {{ $institution->name }}</p>
            </div>
...
<div class="py-8">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow-lg rounded-xl overflow-hidden">
            ...
            <form action="{{ route('institution-admin.departments.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
...
<label for="school_id" class="block text-sm font-medium text-gray-700 mb-2">School *</label>
        ...
        <div class="mt-8 bg-blue-50 rounded-xl p-6">
            <h4 class="text-lg font-semibold text-blue-900 mb-4">💡 Department Setup Tips</h4>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-blue-800">
                <div>
                    <strong>Choose Clear Names:</strong> Use descriptive names that clearly identify the department's focus area.
                </div>
                <div>
                    <strong>Add Description:</strong> Help users understand what this department covers and offers.
                </div>
                <div>
                    <strong>Next Steps:</strong> After creating the department, you can add courses and rooms to it.
                </div>
                <div>
                    <strong>Organization:</strong> Consider how departments will group related courses and resources.
                </div>
            </div>
        </div>
    </div>
